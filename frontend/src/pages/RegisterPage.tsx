  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <FormProvider {...form}>
        ...
        >
          <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-1">REGISTER</h2>
          <p className="text-xs text-slate-500 dark:text-slate-400 mb-5">Create your typing account.</p>

          <AuthFormField name="username" label="USERNAME" type="text" autoComplete="username" />
          ...
          <p className="text-sm mt-4 text-slate-600 dark:text-slate-300">
            ...
            <Link className="font-semibold text-yellow-600 hover:text-yellow-500" to="/login">
              Login
            </Link>
          </p>
        </form>
